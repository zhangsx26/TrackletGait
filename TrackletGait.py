...
class TrackletGait(BaseModel): 
    ...
    def build_network(self, model_cfg):
        ...
        self.layer2 = self.make_layer(BasicBlock2D, 128, [1,2,2], blocks_num=1, h=32, if_tBranch=True)
        ...
        self.layer6 = self.make_layer(BasicBlock2D, 256, [1,2,2], blocks_num=1, h=16, if_tBranch=True)
    ...
    def make_layer(self, block, planes, stride, blocks_num, h=64, if_tBranch=False):
        ...
        # for i in range(1, blocks_num):
            # layers.append(
                    # block(self.inplanes, planes, stride=s, h=h, if_tBranch=if_tBranch)
            # )
